                      ...
                      <tr key={row.id} className="hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors group">
                        ...
                        <td className="px-4 py-4 align-top">
                          <div className="flex items-center gap-1.5 font-semibold text-slate-700 dark:text-slate-200">
                             {row.patientGender === 'Male' ? 'M' : 'F'}, {row.patientAge}y
                          </div>
                        ...
                        <td className="px-4 py-4 align-top">
                          <div className="flex flex-wrap gap-1 max-w-[180px]">
                            {row.drugGroups.map(dg => (
                              <span key={dg} className={`px-1.5 py-0.5 rounded text-[8px] font-bold uppercase ${
                                dg === 'OPIOIDS' ? 'bg-red-50 text-red-600' : 
                                dg === 'NON-OPIOIDS' ? 'bg-green-50 text-green-600' : 'bg-blue-50 text-blue-600'
                              }`}>
                                {dg}
                              </span>
                            ))}
